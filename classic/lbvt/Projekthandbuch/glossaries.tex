...
\newglossaryentry{git}{
	name={Git},
	description={\enquote{Git ist eine freie Software zur verteilten Versionsverwaltung von Dateien. Repositorys sind im Zusammenhang mit Git ein verwaltetes Verzeichnis zur Speicherung und Beschreibung von digitalen Objekten. Das Projekt-Repository wird vom Betreiber BitBucket gehostet.}}
}
